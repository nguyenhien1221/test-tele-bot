...
bot.on("web_app_data", (ctx) => {
  ...
  if (data.data) {
    // User opened an external link
    const openedLink = data.data;
    console.log("User opened link:", openedLink);

    // You can handle the opened link here
    // ...
  } else {
    // User interacted with the WebApp
    console.log("User interacted with the WebApp");

    // You can handle the WebApp interaction here
    // ...
  }
});
